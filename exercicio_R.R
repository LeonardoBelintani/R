...
file.copy(from="C:/Users/Alex/Desktop/Pós/Regressões/carros.csv",
          to="C:/Users/Alex/Desktop/Pós/Regressões/exercicioR/carros.csv")
...
dados <- read.csv(file="C:/Users/Alex/Desktop/Pós/Regressões/exercicioR/carros.csv",
                   header=TRUE,
                   sep=";",
                  dec=",")
# qual o sentido?
